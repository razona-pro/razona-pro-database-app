...
-- Opciones · CPE002
INSERT INTO razonapro.options (competence_id, question_id, option_id, option_text, is_correct) VALUES
('CPE002','QTN0001','OPT_A','$85.000','N'),
('CPE002','QTN0001','OPT_B','$90.000','Y'),
('CPE002','QTN0001','OPT_C','$95.000','N'),
('CPE002','QTN0001','OPT_D','$100.000','N'),

('CPE002','QTN0002','OPT_A','40 estudiantes','N'),
('CPE002','QTN0002','OPT_B','42 estudiantes','N'),
('CPE002','QTN0002','OPT_C','45 estudiantes','Y'),
('CPE002','QTN0002','OPT_D','50 estudiantes','N'),

('CPE002','QTN0003','OPT_A','25 %','N'),
('CPE002','QTN0003','OPT_B','28 %','N'),
('CPE002','QTN0003','OPT_C','30 %','Y'),
('CPE002','QTN0003','OPT_D','35 %','N'),

('CPE002','QTN0004','OPT_A','4.500 habitantes','N'),
('CPE002','QTN0004','OPT_B','4.833 habitantes','Y'),
('CPE002','QTN0004','OPT_C','5.100 habitantes','N'),
('CPE002','QTN0004','OPT_D','4.167 habitantes','N'),

('CPE002','QTN0005','OPT_A','80 km/h','N'),
('CPE002','QTN0005','OPT_B','85 km/h','N'),
('CPE002','QTN0005','OPT_C','90 km/h','Y'),
('CPE002','QTN0005','OPT_D','95 km/h','N'),

('CPE002','QTN0006','OPT_A','$45.000','N'),
('CPE002','QTN0006','OPT_B','$50.000','N'),
('CPE002','QTN0006','OPT_C','$52.500','Y'),
('CPE002','QTN0006','OPT_D','$55.000','N'),

('CPE002','QTN0007','OPT_A','Enero','N'),
('CPE002','QTN0007','OPT_B','Febrero','Y'),
('CPE002','QTN0007','OPT_C','Marzo','N'),
('CPE002','QTN0007','OPT_D','Abril','N'),

('CPE002','QTN0008','OPT_A','10 personas','N'),
('CPE002','QTN0008','OPT_B','12 personas','N'),
('CPE002','QTN0008','OPT_C','15 personas','Y'),
('CPE002','QTN0008','OPT_D','20 personas','N'),

('CPE002','QTN0009','OPT_A','20 %','N'),
('CPE002','QTN0009','OPT_B','22 %','N'),
('CPE002','QTN0009','OPT_C','25 %','Y'),
('CPE002','QTN0009','OPT_D','30 %','N'),

('CPE002','QTN0010','OPT_A','$360.000','N'),
('CPE002','QTN0010','OPT_B','$420.000','N'),
('CPE002','QTN0010','OPT_C','$480.000','Y'),
('CPE002','QTN0010','OPT_D','$500.000','N'),

('CPE002','QTN0011','OPT_A','18','N'),
('CPE002','QTN0011','OPT_B','21','Y'),
('CPE002','QTN0011','OPT_C','24','N'),
('CPE002','QTN0011','OPT_D','36','N'),

('CPE002','QTN0012','OPT_A','$1.080.000','N'),
('CPE002','QTN0012','OPT_B','$1.044.000','N'),
('CPE002','QTN0012','OPT_C','$1.056.000','Y'),
('CPE002','QTN0012','OPT_D','$1.100.000','N'),

('CPE002','QTN0013','OPT_A','108','N'),
('CPE002','QTN0013','OPT_B','144','N'),
('CPE002','QTN0013','OPT_C','162','Y'),
('CPE002','QTN0013','OPT_D','216','N'),

('CPE002','QTN0014','OPT_A','1/6','N'),
('CPE002','QTN0014','OPT_B','1/3','N'),
('CPE002','QTN0014','OPT_C','1/2','Y'),
('CPE002','QTN0014','OPT_D','2/3','N'),

('CPE002','QTN0015','OPT_A','40 %','N'),
('CPE002','QTN0015','OPT_B','42 %','N'),
('CPE002','QTN0015','OPT_C','44 %','Y'),
('CPE002','QTN0015','OPT_D','46 %','N'),

('CPE002','QTN0016','OPT_A','1 hora','N'),
('CPE002','QTN0016','OPT_B','2 horas','Y'),
('CPE002','QTN0016','OPT_C','3 horas','N'),
('CPE002','QTN0016','OPT_D','4 horas','N'),

('CPE002','QTN0017','OPT_A','$150.000','N'),
('CPE002','QTN0017','OPT_B','$165.000','N'),
('CPE002','QTN0017','OPT_C','$175.000','Y'),
('CPE002','QTN0017','OPT_D','$180.000','N'),

('CPE002','QTN0018','OPT_A','240 unidades','N'),
('CPE002','QTN0018','OPT_B','250 unidades','N'),
('CPE002','QTN0018','OPT_C','260 unidades','Y'),
('CPE002','QTN0018','OPT_D','280 unidades','N'),

('CPE002','QTN0019','OPT_A','24 m','N'),
('CPE002','QTN0019','OPT_B','28 m','N'),
('CPE002','QTN0019','OPT_C','32 m','Y'),
('CPE002','QTN0019','OPT_D','36 m','N'),

('CPE002','QTN0020','OPT_A','3,6','N'),
('CPE002','QTN0020','OPT_B','3,7','N'),
('CPE002','QTN0020','OPT_C','3,8','Y'),
('CPE002','QTN0020','OPT_D','4,0','N');
...
-- Opciones · CPE003
INSERT INTO razonapro.options (competence_id, question_id, option_id, option_text, is_correct) VALUES
('CPE003','QTN0001','OPT_A','Publicar la situación en redes sociales.','N'),
('CPE003','QTN0001','OPT_B','Presentar una denuncia ante la Contraloría o la Procuraduría General.','Y'),
('CPE003','QTN0001','OPT_C','Organizar una marcha de protesta frente a la alcaldía.','N'),
('CPE003','QTN0001','OPT_D','Convocar un paro cívico en el municipio.','N'),

('CPE003','QTN0002','OPT_A','El Estado solo debe garantizar el orden público y la seguridad.','N'),
('CPE003','QTN0002','OPT_B','El Estado garantiza derechos formales y condiciones materiales mínimas de dignidad.','Y'),
('CPE003','QTN0002','OPT_C','El Estado puede intervenir en la vida privada de los ciudadanos para garantizar el bienestar.','N'),
('CPE003','QTN0002','OPT_D','El Estado delega todas sus funciones sociales en el sector privado.','N'),

('CPE003','QTN0003','OPT_A','Tutela colectiva ante el rector.','N'),
('CPE003','QTN0003','OPT_B','Acción popular ante un juez.','N'),
('CPE003','QTN0003','OPT_C','Audiencia pública de rendición de cuentas.','Y'),
('CPE003','QTN0003','OPT_D','Derecho de petición ante el Ministerio de Educación.','N'),

('CPE003','QTN0004','OPT_A','Son reconocidos solo a los ciudadanos colombianos mayores de 18 años.','N'),
('CPE003','QTN0004','OPT_B','Son inherentes a la dignidad humana, de aplicación inmediata y protegidos por tutela.','Y'),
('CPE003','QTN0004','OPT_C','Son otorgados por el Estado según las necesidades de cada ciudadano.','N'),
('CPE003','QTN0004','OPT_D','Son derechos que solo aplican en situaciones de emergencia o crisis.','N'),

('CPE003','QTN0005','OPT_A','Que el afectado tenga abogado para presentarla.','N'),
('CPE003','QTN0005','OPT_B','Que el derecho vulnerado sea de carácter económico.','N'),
('CPE003','QTN0005','OPT_C','Que no exista otro mecanismo judicial idóneo para proteger el derecho vulnerado.','Y'),
('CPE003','QTN0005','OPT_D','Que la vulneración haya sido cometida por una entidad del Estado.','N'),

('CPE003','QTN0006','OPT_A','Votar por un candidato a la presidencia.','N'),
('CPE003','QTN0006','OPT_B','Participar en un cabildo abierto municipal.','Y'),
('CPE003','QTN0006','OPT_C','Pagar impuestos oportunamente.','N'),
('CPE003','QTN0006','OPT_D','Respetar las leyes del Estado.','N'),

('CPE003','QTN0007','OPT_A','Acción de tutela.','N'),
('CPE003','QTN0007','OPT_B','Acción de nulidad.','N'),
('CPE003','QTN0007','OPT_C','Acción popular.','Y'),
('CPE003','QTN0007','OPT_D','Acción de grupo.','N'),

('CPE003','QTN0008','OPT_A','Aumentar la eficiencia del Estado concentrando decisiones en el ejecutivo.','N'),
('CPE003','QTN0008','OPT_B','Evitar la concentración del poder y garantizar controles mutuos entre las ramas del poder.','Y'),
('CPE003','QTN0008','OPT_C','Separar la política de la economía para garantizar estabilidad.','N'),
('CPE003','QTN0008','OPT_D','Distribuir los recursos del Estado entre los diferentes territorios.','N'),

('CPE003','QTN0009','OPT_A','Una empresa exige experiencia mínima de dos años para un cargo directivo.','N'),
('CPE003','QTN0009','OPT_B','Una institución niega empleo a una persona por su origen étnico.','Y'),
('CPE003','QTN0009','OPT_C','Un colegio exige un nivel mínimo académico para admitir estudiantes.','N'),
('CPE003','QTN0009','OPT_D','Un banco evalúa la capacidad de pago antes de otorgar un crédito.','N'),

('CPE003','QTN0010','OPT_A','Es legítimo porque en democracia la mayoría siempre tiene la razón.','N'),
('CPE003','QTN0010','OPT_B','Es aceptable si la decisión fue tomada mediante votación libre.','N'),
('CPE003','QTN0010','OPT_C','Es ilegítimo porque los derechos de las minorías no pueden ser vulnerados por la mayoría.','Y'),
('CPE003','QTN0010','OPT_D','Es válido si la minoría tuvo la oportunidad de participar en la votación.','N'),

('CPE003','QTN0011','OPT_A','La Contraloría General de la República.','N'),
('CPE003','QTN0011','OPT_B','La Defensoría del Pueblo.','N'),
('CPE003','QTN0011','OPT_C','La Procuraduría General de la Nación.','Y'),
('CPE003','QTN0011','OPT_D','La Fiscalía General de la Nación.','N'),

('CPE003','QTN0012','OPT_A','Derecho a la intimidad.','N'),
('CPE003','QTN0012','OPT_B','Derecho a la libertad de expresión y de prensa.','Y'),
('CPE003','QTN0012','OPT_C','Derecho al trabajo.','N'),
('CPE003','QTN0012','OPT_D','Derecho a la seguridad personal.','N'),

('CPE003','QTN0013','OPT_A','El referendo.','N'),
('CPE003','QTN0013','OPT_B','La iniciativa popular legislativa.','N'),
('CPE003','QTN0013','OPT_C','La revocatoria del mandato.','Y'),
('CPE003','QTN0013','OPT_D','El plebiscito.','N'),

('CPE003','QTN0014','OPT_A','Los derechos civiles son colectivos y los políticos son individuales.','N'),
('CPE003','QTN0014','OPT_B','Los derechos civiles protegen la libertad individual y los políticos permiten la participación en el gobierno.','Y'),
('CPE003','QTN0014','OPT_C','Los derechos civiles solo aplican en conflictos privados y los políticos en guerras.','N'),
('CPE003','QTN0014','OPT_D','Los derechos civiles son reconocidos por la ley ordinaria y los políticos por tratados internacionales.','N'),

('CPE003','QTN0015','OPT_A','Sí, porque la ley permite votar desde los 16 años en Colombia.','N'),
('CPE003','QTN0015','OPT_B','No, porque en Colombia la mayoría de edad electoral es a los 18 años.','Y'),
('CPE003','QTN0015','OPT_C','Sí, con autorización escrita de sus padres o tutores.','N'),
('CPE003','QTN0015','OPT_D','No, hasta que no haya completado el bachillerato.','N'),

('CPE003','QTN0016','OPT_A','Es el conjunto de normas que regulan el funcionamiento del Congreso.','N'),
('CPE003','QTN0016','OPT_B','Son las normas y principios que, sin estar en la Constitución, tienen rango constitucional.','Y'),
('CPE003','QTN0016','OPT_C','Es la jerarquía de leyes establecida por la Constitución.','N'),
('CPE003','QTN0016','OPT_D','Son los tratados internacionales ratificados por Colombia.','N'),

('CPE003','QTN0017','OPT_A','Acción de tutela.','N'),
('CPE003','QTN0017','OPT_B','Derecho de petición.','N'),
('CPE003','QTN0017','OPT_C','Acción popular.','Y'),
('CPE003','QTN0017','OPT_D','Acción de cumplimiento.','N'),

('CPE003','QTN0018','OPT_A','Las personas deben ser tratadas según su utilidad social.','N'),
('CPE003','QTN0018','OPT_B','Las personas son fines en sí mismas y no pueden ser instrumentalizadas.','Y'),
('CPE003','QTN0018','OPT_C','La dignidad es un privilegio que el Estado otorga a quienes cumplen sus deberes.','N'),
('CPE003','QTN0018','OPT_D','La dignidad solo aplica a los ciudadanos que gozan de plena capacidad civil.','N'),

('CPE003','QTN0019','OPT_A','Juzgar a los funcionarios públicos por delitos comunes.','N'),
('CPE003','QTN0019','OPT_B','Revisar la legalidad de los actos administrativos del ejecutivo.','N'),
('CPE003','QTN0019','OPT_C','Guardar la integridad y la supremacía de la Constitución.','Y'),
('CPE003','QTN0019','OPT_D','Administrar los recursos del Estado de manera eficiente.','N'),

('CPE003','QTN0020','OPT_A','Un Estado donde la religión católica es oficial, pero se toleran otras.','N'),
('CPE003','QTN0020','OPT_B','Un Estado que prohíbe toda expresión religiosa en el espacio público.','N'),
('CPE003','QTN0020','OPT_C','Un Estado que separa las instituciones gubernamentales de las religiosas, garantizando la libertad de cultos.','Y'),
('CPE003','QTN0020','OPT_D','Un Estado que financia por igual a todas las religiones reconocidas legalmente.','N');
...
-- Opciones · CPE004
INSERT INTO razonapro.options (competence_id, question_id, option_id, option_text, is_correct) VALUES
('CPE004','QTN0001','OPT_A','Presentar el contexto histórico del tema tratado.','N'),
('CPE004','QTN0001','OPT_B','Expresar la posición central del autor que será argumentada en el texto.','Y'),
('CPE004','QTN0001','OPT_C','Resumir las fuentes bibliográficas consultadas.','N'),
('CPE004','QTN0001','OPT_D','Describir la metodología utilizada en la investigación.','N'),

('CPE004','QTN0002','OPT_A','El cambio climático es uno de los mayores retos de nuestra época.','N'),
('CPE004','QTN0002','OPT_B','Diversos estudios señalan sus causas antropogénicas.','N'),
('CPE004','QTN0002','OPT_C','Las políticas actuales son insuficientes para detener el cambio climático.','Y'),
('CPE004','QTN0002','OPT_D','El cambio climático tiene causas naturales y artificiales.','N'),

('CPE004','QTN0003','OPT_A','Sin embargo','N'),
('CPE004','QTN0003','OPT_B','Además','N'),
('CPE004','QTN0003','OPT_C','Por lo tanto','Y'),
('CPE004','QTN0003','OPT_D','Por ejemplo','N'),

('CPE004','QTN0004','OPT_A','Presentar nuevos argumentos que refuercen la tesis.','N'),
('CPE004','QTN0004','OPT_B','Retomar la tesis y sintetizar los argumentos desarrollados, sin agregar información nueva.','Y'),
('CPE004','QTN0004','OPT_C','Citar nuevas fuentes bibliográficas para respaldar la posición del autor.','N'),
('CPE004','QTN0004','OPT_D','Plantear nuevas preguntas de investigación sobre el tema.','N'),

('CPE004','QTN0005','OPT_A','Expresar la opinión personal del autor con convicción y claridad.','N'),
('CPE004','QTN0005','OPT_B','Citar datos estadísticos de fuentes verificables que respalden la afirmación.','Y'),
('CPE004','QTN0005','OPT_C','Incluir testimonios de personas cercanas que confirmen el problema.','N'),
('CPE004','QTN0005','OPT_D','Comparar la situación con la de países desarrollados sin una fuente específica.','N'),

('CPE004','QTN0006','OPT_A','Un párrafo que habla de la contaminación, luego de la música y finalmente del deporte.','N'),
('CPE004','QTN0006','OPT_B','Un párrafo que desarrolla únicamente las causas de la deserción escolar en Colombia.','Y'),
('CPE004','QTN0006','OPT_C','Un párrafo que menciona la pobreza, el desempleo y los beneficios del turismo.','N'),
('CPE004','QTN0006','OPT_D','Un párrafo que aborda el calentamiento global y las tradiciones culturales indígenas.','N'),

('CPE004','QTN0007','OPT_A','Usar palabras de difícil comprensión para demostrar dominio del tema.','N'),
('CPE004','QTN0007','OPT_B','Ordenar las ideas de manera lógica y usar conectores que relacionen las partes del texto.','Y'),
('CPE004','QTN0007','OPT_C','Repetir la tesis en cada párrafo para que el lector no la olvide.','N'),
('CPE004','QTN0007','OPT_D','Incluir muchos ejemplos aunque no estén directamente relacionados con la tesis.','N'),

('CPE004','QTN0008','OPT_A','Texto narrativo.','N'),
('CPE004','QTN0008','OPT_B','Texto descriptivo.','N'),
('CPE004','QTN0008','OPT_C','Texto argumentativo.','Y'),
('CPE004','QTN0008','OPT_D','Texto expositivo.','N'),

('CPE004','QTN0009','OPT_A','Usar sinónimos para evitar la repetición innecesaria de palabras.','N'),
('CPE004','QTN0009','OPT_B','Utilizar conectores que no corresponden a la relación lógica entre las ideas.','Y'),
('CPE004','QTN0009','OPT_C','Citar fuentes secundarias para respaldar los argumentos principales.','N'),
('CPE004','QTN0009','OPT_D','Variar la extensión de los párrafos para mantener el interés del lector.','N'),

('CPE004','QTN0010','OPT_A','Usar palabras clave del texto original.','N'),
('CPE004','QTN0010','OPT_B','Mencionar el título y el autor del texto resumido.','N'),
('CPE004','QTN0010','OPT_C','Incluir opiniones personales o interpretaciones no presentes en el texto original.','Y'),
('CPE004','QTN0010','OPT_D','Reducir la extensión del texto original.','N'),

('CPE004','QTN0011','OPT_A','Parafrasear es copiar frases del texto original con pequeños cambios de palabras.','N'),
('CPE004','QTN0011','OPT_B','Parafrasear es reescribir las ideas en palabras propias citando la fuente; plagiar es presentar ideas ajenas como propias.','Y'),
('CPE004','QTN0011','OPT_C','No hay diferencia si se menciona el nombre del autor al final del texto.','N'),
('CPE004','QTN0011','OPT_D','El plagio solo ocurre cuando se copia textualmente más de un párrafo completo.','N'),

('CPE004','QTN0012','OPT_A','Usa demasiados conectores adversativos.','N'),
('CPE004','QTN0012','OPT_B','La oración sobre los videojuegos rompe la unidad temática del párrafo.','Y'),
('CPE004','QTN0012','OPT_C','La tesis no está claramente formulada al inicio del párrafo.','N'),
('CPE004','QTN0012','OPT_D','La conclusión no retoma adecuadamente la idea central.','N'),

('CPE004','QTN0013','OPT_A','Aumentar la extensión del texto para demostrar mayor conocimiento.','N'),
('CPE004','QTN0013','OPT_B','Demostrar que el autor leyó muchos libros sobre el tema.','N'),
('CPE004','QTN0013','OPT_C','Respaldar argumentos con fuentes verificables y atribuir ideas a sus autores originales.','Y'),
('CPE004','QTN0013','OPT_D','Cumplir con los requisitos formales exigidos por el docente.','N'),

('CPE004','QTN0014','OPT_A','"Oye, la tecnología en las aulas está buenísima para aprender mejor."','N'),
('CPE004','QTN0014','OPT_B','"La integración de tecnologías digitales en el aula favorece el desarrollo de competencias del siglo XXI."','Y'),
('CPE004','QTN0014','OPT_C','"Igual, al fin y al cabo, todo depende del profe y de las ganas del estudiante."','N'),
('CPE004','QTN0014','OPT_D','"La tecnología en clase es súper importante y todo el mundo debería usarla."','N'),

('CPE004','QTN0015','OPT_A','Debilitan la tesis al mostrar que existen opiniones en contra.','N'),
('CPE004','QTN0015','OPT_B','Son errores argumentativos que deben evitarse en un buen texto.','N'),
('CPE004','QTN0015','OPT_C','Fortalecen la tesis al demostrar que el autor consideró y rebatió posiciones opuestas.','Y'),
('CPE004','QTN0015','OPT_D','Son útiles solo en textos de opinión, no en ensayos académicos.','N'),

('CPE004','QTN0016','OPT_A','Porque no incluye una cita bibliográfica que lo respalde.','N'),
('CPE004','QTN0016','OPT_B','Porque hace una generalización absoluta sin evidencia que la sustente.','Y'),
('CPE004','QTN0016','OPT_C','Porque usa un lenguaje demasiado coloquial para un texto académico.','N'),
('CPE004','QTN0016','OPT_D','Porque la idea es demasiado obvia y no aporta nada nuevo al debate.','N'),

('CPE004','QTN0017','OPT_A','El expositivo usa imágenes y el argumentativo usa solo texto.','N'),
('CPE004','QTN0017','OPT_B','El expositivo informa objetivamente; el argumentativo defiende una posición para persuadir.','Y'),
('CPE004','QTN0017','OPT_C','El expositivo es más largo y formal que el argumentativo.','N'),
('CPE004','QTN0017','OPT_D','El argumentativo solo se usa en contextos legales y jurídicos.','N'),

('CPE004','QTN0018','OPT_A','Que el texto tenga exactamente la extensión requerida por el docente.','N'),
('CPE004','QTN0018','OPT_B','Que las ideas estén ordenadas lógicamente y el lector pueda seguir el hilo argumentativo.','Y'),
('CPE004','QTN0018','OPT_C','Que no haya ningún error ortográfico ni de puntuación.','N'),
('CPE004','QTN0018','OPT_D','Que todas las fuentes estén en formato APA actualizado.','N'),

('CPE004','QTN0019','OPT_A','Estructura problema-solución.','N'),
('CPE004','QTN0019','OPT_B','Estructura causa-efecto.','N'),
('CPE004','QTN0019','OPT_C','Estructura de contraste o comparación.','Y'),
('CPE004','QTN0019','OPT_D','Estructura cronológica.','N'),

('CPE004','QTN0020','OPT_A','Ser llamativo y creativo para atraer la atención del lector.','N'),
('CPE004','QTN0020','OPT_B','Ser informativo y específico, anticipando el tema central y el enfoque del texto.','Y'),
('CPE004','QTN0020','OPT_C','Ser breve, idealmente de una sola palabra o concepto.','N'),
('CPE004','QTN0020','OPT_D','Incluir el nombre del autor y la institución a la que pertenece.','N');
...
-- Opciones · CPE005
INSERT INTO razonapro.options (competence_id, question_id, option_id, option_text, is_correct) VALUES
('CPE005','QTN0001','OPT_A','Simple Past','N'),
('CPE005','QTN0001','OPT_B','Present Perfect Continuous','Y'),
('CPE005','QTN0001','OPT_C','Past Continuous','N'),
('CPE005','QTN0001','OPT_D','Present Perfect Simple','N'),

('CPE005','QTN0002','OPT_A','rained','N'),
('CPE005','QTN0002','OPT_B','would rain','N'),
('CPE005','QTN0002','OPT_C','rains','Y'),
('CPE005','QTN0002','OPT_D','will rain','N'),

('CPE005','QTN0003','OPT_A','A cause-and-effect relationship.','N'),
('CPE005','QTN0003','OPT_B','A contrast between two ideas.','Y'),
('CPE005','QTN0003','OPT_C','A condition for something to happen.','N'),
('CPE005','QTN0003','OPT_D','A sequence of events in time.','N'),

('CPE005','QTN0004','OPT_A','The manager written the report.','N'),
('CPE005','QTN0004','OPT_B','The report was written by the manager.','Y'),
('CPE005','QTN0004','OPT_C','The report has write by the manager.','N'),
('CPE005','QTN0004','OPT_D','The manager was written the report.','N'),

('CPE005','QTN0005','OPT_A','The impact of climate change on global temperatures.','N'),
('CPE005','QTN0005','OPT_B','Deforestation is a major cause of climate change and threatens biodiversity.','Y'),
('CPE005','QTN0005','OPT_C','Biodiversity loss is the most serious environmental problem today.','N'),
('CPE005','QTN0005','OPT_D','Forests are essential for human survival and economic development.','N'),

('CPE005','QTN0006','OPT_A','You should to wear a helmet.','N'),
('CPE005','QTN0006','OPT_B','You must wear a helmet.','Y'),
('CPE005','QTN0006','OPT_C','You must to wear a helmet.','N'),
('CPE005','QTN0006','OPT_D','You musts wear a helmet.','N'),

('CPE005','QTN0007','OPT_A','Only beneficial for teenagers.','N'),
('CPE005','QTN0007','OPT_B','Both useful and potentially harmful.','Y'),
('CPE005','QTN0007','OPT_C','Primarily a source of anxiety and depression.','N'),
('CPE005','QTN0007','OPT_D','An ineffective communication tool.','N'),

('CPE005','QTN0008','OPT_A','must','N'),
('CPE005','QTN0008','OPT_B','should','N'),
('CPE005','QTN0008','OPT_C','can','Y'),
('CPE005','QTN0008','OPT_D','have to','N'),

('CPE005','QTN0009','OPT_A','Each student are responsible for their own work.','N'),
('CPE005','QTN0009','OPT_B','Each student is responsible for their own work.','Y'),
('CPE005','QTN0009','OPT_C','Each students is responsible for their own work.','N'),
('CPE005','QTN0009','OPT_D','Each student be responsible for their own work.','N'),

('CPE005','QTN0010','OPT_A','Future Simple Passive','N'),
('CPE005','QTN0010','OPT_B','Future Continuous','N'),
('CPE005','QTN0010','OPT_C','Future Perfect Passive','Y'),
('CPE005','QTN0010','OPT_D','Present Perfect Passive','N'),

('CPE005','QTN0011','OPT_A','Increase','N'),
('CPE005','QTN0011','OPT_B','Remain stable','N'),
('CPE005','QTN0011','OPT_C','Decrease','Y'),
('CPE005','QTN0011','OPT_D','Improve','N'),

('CPE005','QTN0012','OPT_A','which','N'),
('CPE005','QTN0012','OPT_B','that','N'),
('CPE005','QTN0012','OPT_C','who','Y'),
('CPE005','QTN0012','OPT_D','whose','N'),

('CPE005','QTN0013','OPT_A','To inform consumers about product safety regulations.','N'),
('CPE005','QTN0013','OPT_B','To persuade consumers to make a purchase.','Y'),
('CPE005','QTN0013','OPT_C','To warn consumers about a limited product supply.','N'),
('CPE005','QTN0013','OPT_D','To describe the features of a new product.','N'),

('CPE005','QTN0014','OPT_A','To swim regularly is improving cardiovascular health.','N'),
('CPE005','QTN0014','OPT_B','Swimming regularly improves cardiovascular health.','Y'),
('CPE005','QTN0014','OPT_C','Swim regularly improve cardiovascular health.','N'),
('CPE005','QTN0014','OPT_D','Regularly swimming it improves cardiovascular health.','N'),

('CPE005','QTN0015','OPT_A','A complaint letter to a company.','N'),
('CPE005','QTN0015','OPT_B','A formal job application or inquiry letter.','Y'),
('CPE005','QTN0015','OPT_C','An informal message to a colleague.','N'),
('CPE005','QTN0015','OPT_D','A thank-you note for an interview.','N'),

('CPE005','QTN0016','OPT_A','already started','N'),
('CPE005','QTN0016','OPT_B','has already started','N'),
('CPE005','QTN0016','OPT_C','had already started','Y'),
('CPE005','QTN0016','OPT_D','was already starting','N'),

('CPE005','QTN0017','OPT_A','A factual description of transportation systems.','N'),
('CPE005','QTN0017','OPT_B','A recommendation or proposal to the government.','Y'),
('CPE005','QTN0017','OPT_C','A criticism of the current government''s performance.','N'),
('CPE005','QTN0017','OPT_D','A prediction about future transportation trends.','N'),

('CPE005','QTN0018','OPT_A','She said that she is tired.','N'),
('CPE005','QTN0018','OPT_B','She said that she was tired.','Y'),
('CPE005','QTN0018','OPT_C','She said that she were tired.','N'),
('CPE005','QTN0018','OPT_D','She said that she has been tired.','N'),

('CPE005','QTN0019','OPT_A','To argue that technology dehumanizes society.','N'),
('CPE005','QTN0019','OPT_B','To present two contrasting perspectives on the role of technology.','Y'),
('CPE005','QTN0019','OPT_C','To defend the idea that technology brings people closer together.','N'),
('CPE005','QTN0019','OPT_D','To describe the negative effects of technology on human relationships.','N'),

('CPE005','QTN0020','OPT_A','however','N'),
('CPE005','QTN0020','OPT_B','although','N'),
('CPE005','QTN0020','OPT_C','therefore','Y'),
('CPE005','QTN0020','OPT_D','despite','N');
