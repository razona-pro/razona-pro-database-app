CREATE TABLE razonapro.students_responses (
    ...
    CONSTRAINT FK_STUD_RESP_TRIEDS      FOREIGN KEY (test_id, program_id, student_id, tried_id)
        REFERENCES razonapro.trieds (test_id, program_id, student_id, tried_id)
        ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT UN_STUDENTS_RESPONSES    UNIQUE (test_id, program_id, student_id, tried_id, question_id),
