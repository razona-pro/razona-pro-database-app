CREATE TABLE razonapro.questions (
    ...
    source          VARCHAR(50),
    difficulty_level CHAR(1),  -- opcional: la Saber Pro no maneja dificultad; NULL = "no aplica"
    ...
    CONSTRAINT CK_QUESTIONS_DIFFICULTY_LEVEL   CHECK (difficulty_level IS NULL OR difficulty_level IN ('B','M','A')),
